    ...
    class GameplayScreen : GameScreen
    {
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (m == null)
            {
                if (level.IsLevelUp)
                {
                    m = new MessageBoxScreen(gameContent.levelUp, null);
                    BitSitsGames.ScoreData.Level = levelIndex;

                    if (levelIndex == MaxLevelIndex)
                    {
                        m = new MessageBoxScreen(gameContent.gameOver, null);
        ...
        private void DrawScore(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(gameContent.gameFont,
                "level: " + levelIndex + " / " + MaxLevelIndex, new Vector2(320, 0), Color.White,
                0, Vector2.Zero, 0.75f, SpriteEffects.None, 1);
        }
