...
namespace BitSits_Framework
{
    ...
    class OptionsMenuScreen : MenuScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            soundMenuEntry = new MenuEntry(this, string.Empty, new Vector2(450, 320));
            musicMenuEntry = new MenuEntry(this, string.Empty, new Vector2(450, 390));

            SetMenuEntryText();

            MenuEntry backMenuEntry = new MenuEntry(this, "Back", new Vector2(480, 500));
